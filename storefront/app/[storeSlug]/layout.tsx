...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    icons: {
      icon: store.tenant?.logoUrl || "/brands/chesters/chesters-logo.png",
      apple: "/brands/chesters/apple-touch-icon.png",
      other: [
        { rel: "icon", type: "image/png", sizes: "16x16", url: "/brands/chesters/favicon-16x16.png" },
        { rel: "icon", type: "image/png", sizes: "32x32", url: "/brands/chesters/favicon-32x32.png" },
        { rel: "icon", type: "image/png", sizes: "48x48", url: "/brands/chesters/favicon-48x48.png" },
        { rel: "icon", type: "image/png", sizes: "192x192", url: "/brands/chesters/android-chrome-192x192.png" },
        { rel: "icon", type: "image/png", sizes: "512x512", url: "/brands/chesters/android-chrome-512x512.png" },
      ],
    },
    manifest: undefined,
  }
