  ...
  theme: {
    extend: {
      colors: {
        ...
        destructive: { DEFAULT: "hsl(var(--destructive))", foreground: "hsl(var(--destructive-foreground, 0 0% 100%))" },
      ...
      borderRadius: {
        card: "var(--radius-card, 1.625rem)",
        "card-lg": "var(--radius-card-lg, 2.125rem)",
        pill: "var(--radius-pill, 128px)",
      },
      boxShadow: {
        card: "var(--shadow-card, 0 12px 35px rgba(11, 30, 76, 0.10))",
        "card-lg": "var(--shadow-card-lg, 0 24px 70px rgba(11, 30, 76, 0.12))",
      },
      keyframes: {
        "sheet-in": {
